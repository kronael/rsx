...
match. Their model is [network-edge-io](04-network-edge-io.md).
...
[network-edge-io](04-network-edge-io.md).
...
a kernel polling thread. See [network-edge-io](04-network-edge-io.md).
...
[docs/concepts/03-spsc-rings.md](../../docs/concepts/03-spsc-rings.md),
[docs/concepts/04-network-edge-io.md](../../docs/concepts/04-network-edge-io.md)

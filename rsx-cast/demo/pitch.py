...
NARRATIVE = [
    ...
    ("a broker", RUST), (" adds hops, ", FG),
    ("hand-rolled\nUDP", RUST), (" needs endless patching, and\n", FG),
    ("fsync on every byte", RUST), (" costs\n", FG),
    ("milliseconds", RUST), (" — a thousand times\nthe network hop.\n\n", FG),
    ("Yet your servers never all die\nat once.", TEAL),
    (" Why pay for that?\n\n", FG),

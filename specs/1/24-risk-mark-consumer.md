...
# Plan: Risk Mark Price replication Consumer
...
Mark process publishes MarkPriceEvent records via casting.
Risk needs a casting receiver for mark prices, decode them,
and store in shard state for use by check_liquidation.

---

### Stage 1: Add mark price casting receiver to risk

**Goal**: Risk receives MarkPriceEvent from Mark process
via casting, stores latest mark price per symbol in shard.
...
- [ ] Mark price casting receiver created in main
